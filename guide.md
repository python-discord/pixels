...
For this example we'll use the `/set_pixel` endpoint to set a specific pixel on the canvas. Firstly we want to import our HTTP library, for ow we'll use the `requests` (`pip install requests`) library.
